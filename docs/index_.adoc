...
* The Test Case link:../Scripts/DuckDuckGo/main/Script1667437517277.groovy[DuckDuckGo/main] visits a single Web site.
...
* The Test Case link:../Scripts/CURA/main/Script1667709715867.groovy[CURA/main] visits a single Web site
...
The Test Case link:../Scripts/CURA/main/Script1667709715867.groovy[CURA/main] sets up the parameters and calls the Test Case link:../Scripts/CURA/materialize/Script1667709728945.groovy[CURA/materialize]. The `main` testcase executes `com.kazurayam.inspectus.katalon.KatalonChronosDiff` object, which performs all diffing and reporting tasks etc behind the scene.
...
* The Test Case link:../Scripts/CURA/main/Script1667709715867.groovy[CURA/main] visits 2 Web sites which have the same sitemap; namely Production environment and Development environment.
