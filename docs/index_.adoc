...
image:https://kazurayam.github.io/inspectus4katalon-sample-project/images/Apple_I_bit.png[]
...
1. You need Java, Katalon Studio, Gradle installed. Please follow the link:https://kazurayam.github.io/inspectus4katalon-sample-project/index#installing-and-setting-up-katalon-studio[instruction].
