...
/**
 * Test Cases/DuckDuckGo/run_materialize
 */
Path projectDir = Paths.get(RunConfiguration.getProjectDir())
Store store = Stores.newInstance(projectDir.resolve("store"))
JobName jobName = new JobName("AppleShootings_run_materialize")
...
WebUI.callTestCase(findTestCase("Test Cases/AppleShootings/materialize"), p);
